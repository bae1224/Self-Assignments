...
C02L = np.column_stack([R, t])                            # 3x4 Matrix
C02L = np.insert(C02L, 3, values = [0,0,0,1], axis=0)     # 4x4 Matrix
## =================================================================
...
C02C2 = np.column_stack([R_02, T_02])                       # 3x4 Matrix
C02C2 = np.insert(C02C2, 3, values = [0,0,0,1], axis=0)     # 4x4 Matrix
## =================================================================
...
## =================================================================
C22L = np.linalg.inv(C02C2 @ C02L)             # OPLUS 행렬곱
## =================================================================
...
pts_c2 = np.linalg.inv(C22L) @ ptcloud   # 4xn Homogeneous Coordinate
